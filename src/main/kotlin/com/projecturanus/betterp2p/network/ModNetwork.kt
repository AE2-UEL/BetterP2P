...
object ModNetwork {
  ...
  fun registerNetwork() {
    ...
    channel.registerMessage(
        ClientOpenGuiHandler::class.java, S2COpenGui::class.java, id++, Side.CLIENT)
    channel.registerMessage(
        ClientUpdateP2PHandler::class.java, S2CUpdateP2P::class.java, id++, Side.CLIENT)

    channel.registerMessage(
        ServerLinkP2PHandler::class.java, C2SLinkP2P::class.java, id++, Side.SERVER)
    channel.registerMessage(
        ServerCloseGuiHandler::class.java, C2SCloseGui::class.java, id++, Side.SERVER)
    channel.registerMessage(
        ServerUpdateInfoHandler::class.java, C2SUpdateMemoryInfo::class.java, id++, Side.SERVER)

    channel.registerMessage(
        ServerRenameP2PTunnel::class.java, C2SRenameP2P::class.java, id++, Side.SERVER)
    channel.registerMessage(
        ServerRefreshP2PListHandler::class.java, C2SRefreshP2PList::class.java, id++, Side.SERVER)
    channel.registerMessage(
        ServerUnlinkP2PHandler::class.java, C2SUnlinkP2P::class.java, id++, Side.SERVER)
    channel.registerMessage(
        ServerTypeChangeHandler::class.java, C2STypeChange::class.java, id++, Side.SERVER)
    networkWorker =
        ...
        networkWorker.schedule(
            {
              synchronized(ModNetwork.playerState) {
                channel.sendTo(
                    S2CUpdateP2P(cache.retrieveP2PList(), true), player as EntityPlayerMP)
