    ...
    if (info != null) {
      ...
      if (info.output) {
        drawTexturedQuad(
            ...
            y + 20.0,
            144.0 / GUI_WIDTH,
            200.0 / GUI_TEX_HEIGHT,
            160.0 / GUI_WIDTH,
            216.0 / GUI_TEX_HEIGHT)
      } else {
        drawTexturedQuad(
            Tessellator.getInstance(),
            x.toDouble(),
      ...
      if (renderNameTextfield) {
        fontRenderer.drawString(
            I18n.format("gui.advanced_memory_card.name", info.name), leftAlign, y + 3, 0)
      } else {
        fontRenderer.drawString(
            I18n.format("gui.advanced_memory_card.name", ""), leftAlign, y + 3, 0)
      }
